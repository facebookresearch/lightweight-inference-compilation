...
LOGGER_IC = logging.getLogger("LIC.debug.ic")
...
class ICInference(AbstractMHInference):
    ...
    def compile(  # noqa: C901
        ...
        self.reset()
        self.queries_ = set(query_hints if query_hints else [])
        ...
        optimizer = optimizer_func([nn.Parameter(torch.zeros(1))])
        if self._obs_embedding_net:
