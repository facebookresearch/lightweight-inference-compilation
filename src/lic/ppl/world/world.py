...
from ..model.utils import get_wrapper
from .diff import Diff
from .diff_stack import DiffStack
from .variable import TransformData, TransformType, Variable
from .world_vars import WorldVars
from torch import Tensor


world_context = contextvars.ContextVar("LIC.ppl.world", default=None)
...
class World(object):
    ...
    defaultdict(<class 'LIC.ppl.utils.variable.Variable'>,
    {
